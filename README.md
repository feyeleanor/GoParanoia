...
$ go run 35_web_service_hybrid_key_exchange.go http.go pem.go rsa.go helpers.go errors.go test3.pem session_label "0123456789012345"
Bob received request for public key from 127.0.0.1:49592
Alice received public key: &{ 65537}
Alice sends symmetric key: 0123456789012345
Bob received symmetric key: 0123456789012345

$ go run 36_web_service_hybrid_send_messages.go http.go pem.go rsa.go aes.go helpers.go errors.go test3.pem session_label 0123456789012345 A B C
...
$ go run 37_web_service_hybrid_dual_key_streams.go  http.go pem.go rsa.go aes.go helpers.go errors.go test3.pem session_label 0123456789012345 A B C
